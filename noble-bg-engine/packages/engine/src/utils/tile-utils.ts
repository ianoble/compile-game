...
export function getTileAt(layer: TileLayer, row: number, col: number): PlacedTile | undefined {
...
export function getTileCells(layer: TileLayer, tileId: string): [number, number][] | undefined {
